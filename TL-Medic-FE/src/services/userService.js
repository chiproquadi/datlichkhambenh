...
const filterBookingsByPatientId = (data) => {
  return axios.post("/api/filter-bookings-by-patient-id", data);
};

// API hủy đặt lịch theo bookingId
const cancelBookingUser = (data) => {
  return axios.delete("/api/cancel-booking", {
    data: {
